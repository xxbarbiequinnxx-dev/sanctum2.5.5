...
/** Which database backend is active. Setup / playbook / switch live in migrations/0016. */
...
export function getSql(): Promise<Sql> {
  // HMR after 0008 house settings + location re-runs pending files on shared PGLite.
  // HMR after 0012 sort_order + audio_data.
  // HMR after 0015 experience.
